...
export const FEATURED_REVIEWS = [
  {
    quote: "The dough is crispy on the outside, soft and flaky inside.",
    name: "László O.",
    context: "Local Guide",
  },
  {
    quote: "Finally something new. You can tell the sauces are homemade, not off a shelf.",
    name: "Zsófia L.",
  },
  {
    quote: "Perfect gluten structure.",
    name: "Botond K.",
  },
];
